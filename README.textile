...
1. define the AutowireViewRegistrator class as a singleton in your subview applicationContext and set the subview applicationContext
object on the viewRegistrator.
